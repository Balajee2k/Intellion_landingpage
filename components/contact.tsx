    ...
    <section id="contact" className="py-20 bg-gray-50 dark:bg-gray-800/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-2 text-3xl font-extrabold text-gray-900 dark:text-white sm:text-4xl">Get in Touch</p>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-purple-100">123 Innovation Drive, Tech City, TC 10101</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-purple-100">info@intelion.com</p>
                </div>
              </div>
            </div>
